...
from ui_utils import main_menu_keyboard
from logging_utils import log_wrong_access, log_error
from ui_utils import send_main_menu
...
async def cancel(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    from config import pending_action
    if user_id in pending_action:
        ...
        try:
            from message_cleanup import purge_auth_messages_for_user
